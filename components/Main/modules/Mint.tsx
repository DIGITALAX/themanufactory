...
const Mint: FunctionComponent<MintProps> = ({ image }): JSX.Element => {
  return (
    <div className="relative w-4/5 preG:w-3/4 sm:w-96 casi:w-100 h-full flex flex-col justify-center">
      <div className="absolute h-[20rem] preG:h-[30rem] sm:h-[35rem] casi:h-[45rem] border border-white left-3 top-3 w-full flex items-center justify-center"></div>
      <div
      ...
      <div
        className="absolute w-36 antes:w-44 h-48 antes:h-60 z-10 bottom-30 justify-center flex items-center left-10"
        id="bounce2"
      >
        <Image
